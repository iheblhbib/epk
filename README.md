...
The seeder creates a demo login: **demo@koraxx.test** / **password**, already a member of a seeded "KORAXX Demo" workspace (as owner), with a second teammate and one pending invitation — so the dashboard isn't empty on first login.
